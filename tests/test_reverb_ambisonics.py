...
from scaper.reverb_ambisonics import _validate_IR_length


def test_validate_IR_length():

    def __test_bad_IR_length_tuple(IR_length_tuple):
        pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_IR_length, IR_length_tuple)
    ...
    def __assert_correct_IR_length_tuple(IR_length_tuple):
        try:
            scaper.reverb_ambisonics._validate_IR_length(IR_length_tuple)
        except ScaperError:
            raise ScaperError
...
def test_validate_room_dimensions():
    ...
    def __test_bad_room_dimensions_tuple(room_dimensions_tuple):
        pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_room_dimensions, room_dimensions_tuple)
    ...
    pytest.warns(ScaperWarning, scaper.reverb_ambisonics._validate_room_dimensions, ('normal', 5, 2))
    ...
    def __assert_correct_room_dimensions(room_dimensions_tuple):
        try:
            scaper.reverb_ambisonics._validate_room_dimensions(room_dimensions_tuple)
        except ScaperError:
            raise ScaperError
...
def test_validate_t60():
    ...
    def __test_bad_t60_tuple(t60_tuple):
        pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_t60, t60_tuple)
    ...
    # using normal will issue a warning since it can generate neg values
    pytest.warns(ScaperWarning, scaper.reverb_ambisonics._validate_t60, ('normal', 5, 2))
    ...
    def __assert_correct_t60(t60):
        try:
            scaper.reverb_ambisonics._validate_t60(t60)
        except ScaperError:
            raise ScaperError
...
def test_validate_wall_reflectivity():
    ...
    def __test_bad_wall_reflectivity_tuple(wall_reflectivity_tuple):
        pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_wall_reflectivity, wall_reflectivity_tuple)
    ...
    pytest.warns(ScaperWarning, scaper.reverb_ambisonics._validate_wall_reflectivity, ('normal', 5, 2))
    ...
    def __assert_correct_wall_reflectivity(wall_reflectivity_tuple):
        try:
            scaper.reverb_ambisonics._validate_wall_reflectivity(wall_reflectivity_tuple)
        except ScaperError:
            raise ScaperError
...
def test_validate_source_type():
    ...
    pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_source_type, ('const', 'X'))

    # Choose list must be subset of SMIR_ALLOWED_SOURCE_TYPES
    pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_source_type, ('choose', ['X']))
    ...
    for bsd in bad_source_type_dists:
        pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_source_type, bsd)

    # Correct values
    try:
        scaper.reverb_ambisonics._validate_source_type(('const','s'))
        scaper.reverb_ambisonics._validate_source_type(('choose',['s','c']))
    except ScaperError:
        raise ScaperError
...
def test_validate_microphone_type():
    ...
    pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_microphone_type, ('const', 'X'))

    # Choose list must be subset of SMIR_SUPPORTED_VIRTUAL_MICS.keys()
    pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_microphone_type, ('choose', ['X']))
    ...
    for bmd in bad_microphone_type_dists:
        pytest.raises(ScaperError, scaper.reverb_ambisonics._validate_microphone_type, bmd)

    # Correct values
    try:
        scaper.reverb_ambisonics._validate_microphone_type(('const',"em32"))
        scaper.reverb_ambisonics._validate_microphone_type(('choose',["soundfield","tetramic"]))
    except ScaperError:
        raise ScaperError
